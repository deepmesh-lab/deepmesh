...
def train_student_encoder(teacher_model, train_paths):
    ...
    torch.save(student.state_dict(), f'./AI_Real/KD_CNN_OCSVM/Model/student_encoder_kd_k8s_{EPOCHS}_1x8_v2.pth')
    return student

# === Main ===
def main():
    teacher = Encoderv2().to(DEVICE)
    teacher.load_state_dict(torch.load(f'./AI_Real/CNN_OCSVM/Model/cnn_deep_contrastive_encoder_k8s_0.1_1_v2.pth'))
